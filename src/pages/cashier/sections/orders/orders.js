...
<br><br>
                    ...
                    <hr>
                        Order Number: <b>`+ $(this).attr("order_no") + `   </b> <br>
                        Order Date: <b>`+ pending_data_collections[$(this).attr('order_no')]['order_information'].date + `</b> <br>
                        Shipping Fee: ₱ <b>`+ $('#mdom_txt_shipping_fee').val() + `   </b><br>
                        Payment Mode: <b>GCASH</b>
                    <hr>
        ...
        $('#md_om_btn_accept_payment_confirm').unbind('click').click(function () {
            ...
            _POST(con_txns, payload_data, (cb) => {
                payload = {
                    ...
                    <b> Dear `+ $('#lbl_fname').val() + `,</b>
                    <br><br>
                    We are thrilled to inform you that your payment has been received. <br>
                    Expect a staff to give you a call for further instructions.
                    <br><br>
                    Thank you for being a valued customer.
                    <br><br>
                ...
                _POST('src/database/controllers/emailer.php', payload, (cb) => {
                    ...
                    $('.om_btn_load_to_pay').trigger('click')
                })
            });
        })
