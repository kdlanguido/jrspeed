<!-- ORDERS MONITORING -->
<div class="row page" id="page_orders" style="display:none">
            ...
            <div class="border border-top-0 p-3 tab-pane fade show active" style="min-height:20vh; max-height:75vh; overflow-y:auto" id="om_pending_tab" role="tabpanel" tabindex="0">
                ...
                <div class="card p-2 mt-2">
                    <div class="d-flex justify-content-between">
                        <h6>ORDER # : 858746</h6>
                        <div>
                            <button class="btn btn-sm btn-outline-secondary om_btn_view_details">View Details</button>
                        </div>
                    </div>
...
<script src="src/pages/admin/sections/orders/orders.js"></script>