...
<div class="row page" id="page_stocks" style="display:none">
    ...
    <div class="col p-2 mt-3">
        ...
        <input type="text" class="form-control form-control-sm mb-2" placeholder="Search..." style="width:230px; float:right" id="s_txt_search">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="div__stocks_add">
                    ...
                    <input type="text" class="form-control _required _required_int mb-2" id="sts_stock_count">

                    <label>Low Stock Indicator</label>
                    <input type="text" class="form-control _required _required_int mb-2" id="sts_stock_lsi">
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" id="md_sts_add_product">Save</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="div__stock_update">
                    <label>Product</label>
                    <input type="text" class="form-control mb-2 _required _required_string" id="sts_si_stock_product" readonly>

                    <label>Stock Count</label>
                    <input type="text" class="form-control mb-2 _required _required_int" id="sts_si_stock_count">

                    <label>Low Stock Indicator</label>
                    <input type="text" class="form-control mb-2 _required _required_int" id="sts_si_stock_lsi">
                </div>

            </div>
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" id="md_sts_si_save">Save Changes</button>
            </div>
        </div>
    </div>
</div>
