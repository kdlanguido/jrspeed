    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul id="sidebar_admin">
                    <li class="mb-2 ms-3">
                        ...
                        <ul class="sidenav-list ms-0 ps-1">
                            <li class="mb-1 sidebar_btn" goto="page_product_maintenance" id="a__sidebar_products">
                                <a class="text-dark ms-1">
                                    <i class="fa-solid fa-bicycle fa-fw fa-sm pe-1"></i>
                                    Product Maintenance
                                </a>
                            </li>
                            <li class="mb-1 sidebar_btn" goto="page_accounts">
                                <a class="text-dark ms-1">
                                    <i class="fa-solid fa-user-group  fa-fw fa-sm pe-1"></i>
                                    Accounts Maintenance
                                </a>
                            </li>
                            <li class="mb-1 sidebar_btn" goto="page_faq">
                                <a class="text-dark ms-1">
                                    <i class="fa-solid fa-file-circle-question fa-fw fa-sm pe-1"></i>
                                    FAQ Maintenance
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="mb-2 ms-3">
                        ...
                        <ul class="sidenav-list ms-0 ps-1">
                            <li class="mb-1 sidebar_btn" goto="page_stocks">
                                <a class="text-dark ms-1" style="position:relative;">
                                    <i class="fa-solid fa-cart-flatbed fa-fw fa-sm pe-1"></i></i>
                                    Stocks Monitoring
                                    <span class="bg-danger rounded-circle p-1 stocks_indicator" style="display:none;position:absolute; right:-10px; top:0 "></span>
                            ...
                            <li class="mb-1 sidebar_btn" goto="page_sales_monitoring">
                                <a class="text-dark ms-1">
                                    <i class="fa-solid fa-chart-line fa-fw fa-sm pe-1"></i>
                                    Sales Monitoring
                                </a>
                            </li>
                    ...
                    <li class="mb-2 ms-3">
                        <small class="text-secondary">MESSAGING</small>
                        <ul class="sidenav-list ms-0 ps-1">
                            <li class="mb-1 sidebar_btn" goto="page_feedbacks">
                                <a class="text-dark ms-1">
                                    <i class="fa-solid fa-comments fa-fw fa-sm pe-1"></i></i>
                                    Customers Feedback
                                </a>
                            </li>
            ...
            <div class="col">
                ...
                <?php
                include 'src/pages/admin/sections/products/products.php';
                include 'src/pages/admin/sections/orders/orders.php';
                include 'src/pages/admin/sections/accounts/accounts.php';
                include 'src/pages/admin/sections/faq/faq.php';
                include 'src/pages/admin/sections/stocks/stocks.php';
                include 'src/pages/admin/sections/feedbacks/feedbacks.php';
                include 'src/pages/admin/sections/sales_monitoring/sales_monitoring.php';
                ?>
