...
(51, 'ORD.20230920180038', '2023-09-20', '::1', 'PENDING');
...
(23, 'ORD.20230824890882', '2023-08-24', 20, 'COMPLETED', '2023-08-24', 'Wv9au29Ziwkl'),
(24, 'ORD.20230825968719', '2023-08-25', 21, 'TO_RECEIVE', '2023-08-25', 'qwe123'),
(25, 'ORD.20230830311980', '2023-08-30', 22, 'COMPLETED', '2023-08-30', '55559123'),
...
(28, 'ORD.20230905819230', '2023-09-05', 23, 'PENDING', NULL, NULL),
(29, 'ORD.20230905573700', '2023-09-05', 24, 'COMPLETED', '2023-09-05', '55559123'),
...
(19, 'ORD.20230905819230', '2023-09-05', 'gcash', 0, 0, 0, 0, 'UNPAID', NULL, NULL, NULL),
...
INSERT INTO `tbl_products` (`id`, `product_name`, `price`, `category`, `sub_category`, `description`, `product_tag`, `is_featured`) VALUES
(12, 'Sigma Lithium Battery', 100, 'ELECTRONICS', 'Batteries', 'Sigma Lithium Batteries for electronics.', 'accessories', 1),
(13, 'SRAM eTap Blip Box', 5000, 'ELECTRONICS', 'Computers', 'BlipBox is the control module that turns your triathlon or time trial bike into a sleek machine. Connected to SRAM eTap¬Æ Blip‚Ñ¢ remote shifters, the BlipBox‚Ñ¢ manages the wireless shifting via AIREA‚Ñ¢, SRAM‚Äôs proprietary communication protocol, allowing immediate shifts from nearly any aero position.', 'accessories', 1),
(14, 'Lezyne Phone Holder', 2000, 'ELECTRONICS', 'Phone Accessories', 'Can\'t wait another minute to get your hands on the latest gear?', 'accessories', 1),
(15, 'Electra Bell Universal Fit Pinger Bell', 5000, 'SAFETY / SECURITY', 'Bells / Horns', 'The Pinger Bell provides big sound in a small package.', 'accessories', 1),
(16, 'Fox MY21 Mud Guard 36-38 Blk AM', 5000, 'SAFETY / SECURITY', 'Fenders', 'The Mudguard fender mounts easily and cleanly to your fork; a direct-mount design eliminates the need for fork-scratching zip ties and ensures your line of sight stays clear. It also reduces maintenance downtime by minimizing the amount of debris hitting your stanchions and fork seals.', 'accessories', 1),
(18, 'Specialized Stumpjumper Alloy', 15000, 'Mountain Bikes', '', 'THE TRAIL BENCHMARK — When we set out to design the all-new Stumpjumper, we pursued some hefty goals. It had to excel on any kind of trail, for every style of rider. To achieve that, we went after serious weight reduction without sacrificing durability, a stiff, responsive chassis that still rides light and lively, geometry that improves everyone’s riding, and the best suspension kinematics we know how to design. Turns out, you can have your cake and eat it too with the new Stumpjumper.', 'bikes', 0),
(19, 'SKS X-Mud Downtube Fender', 900, 'WHEELS / TIRES', 'Accessories', 'Suitable for both mountain and road applications.', 'components', 1),
(20, 'Stacyc Bar Riser Kit Blk', 5000, 'Controls', 'BMX Bars', 'STACYC Bar Riser Kit\r\nThe Handlebar Riser Kit for STACYC eDrive balance bikes gives your growing rider 4\" of additional vertical rise at the bars. Kit includes everything necessary for a safe, secure installation with basic hand tools.  The Bar Riser Kit helps riders get the most from their eDrive bike - until the 75 pound weight capacity is reached - and makes for a smoother transition to small displacement motorbikes.   ', 'components', 1),
(21, 'Cervelo \"e\" Logo Handlebar Tape Black w/opkge', 1000, 'Controls', 'Bar Tape', 'Experience comfort like never before with Cervelo\'s comfortable and grippy handlebar tape', 'components', 1),
(22, 'Specialized Comp Alloy Short Reach Road Bar', 5000, 'Controls', 'Drop Bars', 'As their name implies, the Short Reach handlebars are designed for those that require a shorter reach in order to obtain the optimal bike fit. Along these lines, they feature a 65mm reach (which is about 10 to 15mm shorter than \"average\") and a shallow 125mm drop. This also comes with the added benefit of increased control at the hoods and levers. And for the construction, we selected a lightweight, yet highly durable, 6061 Premium Butted Aluminum that\'s sure to stand up to years of hard riding. ', 'components', 1),
(23, '2021 Cannondale 700 M Synapse 105', 9000, 'ROAD BIKES', 'Endurance', 'A road bike that’s light, stiff, fast and surprisingly comfortable. Your rides will go longer. You\'ll barely notice. ALLOY FRAME D', 'bikes', 0),
(24, 'SE Bikes Everyday', 9000, 'ACTIVE / CRUISER / BMX', 'BMX Bikes', 'The Everyday is the perfect bike to thrash on. It comes equipped with tapered fork legs, 3-piece cranks, mid-bottom bracket, and extra-wide 2.3\" tires. Whether riding the trails, street, or park, this bike is ready to get rad. Every day.', 'bikes', 0),
(25, 'Electra Cruiser Lux 3i Men\'s 26', 9000, 'ACTIVE / CRUISER / BMX', 'Cruiser Bikes', 'The Cruiser Lux elevates the basic Cruiser to the next level with modern refinements like a lightweight aluminum frame, custom components and, of course, Electra’s patented Flat Foot Technology®. With a 3-speed internal hub, it\'s practical yet eye-catching, making it perfect for cruising in style year round.', 'bikes', 0),
(26, 'Specialized Rockhopper 29', 9000, 'Mountain Bikes', 'Hardtails', 'Better performance. Better value. Better Rockhopper. By tapping the fit and handling advantages of pairing each rider with their ideal wheel size and suspension that works its hardest for everyone thanks to our size-specific Rx Tune, we’ve baked in added performance to the all-new Rockhopper without dialing up the price.Shimano and MicroSHIFT team up for drivetrain duties with a robust 2x8 drivetrain that can handle everything you’re throw down while confident braking from Radius CX7 mechanical disc brakes seals the deal of the century.', 'bikes', 0),
(28, 'Armwrestling Strap', 1000, 'Armwrestling', 'Accessory', 'blablabla', 'accessories', 1),
(29, 'Black Bmx Bar', 100, 'Controls', 'BMX Bars', 'testtestt', 'components', 0),
(30, 'Specialized Stumpjumper Alloy', 50000, 'Mountain Bikes', 'Full Suspension', 'test', 'bikes', 1);
...
(25, NULL, '1', 1, '091827837281', 'kdlanguido@gmail.com', 'King', 'Languido', '225 scorpion st', 0),
